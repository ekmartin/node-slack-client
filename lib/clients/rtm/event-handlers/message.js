...
var handlers = [
    ...
    [makeMessageEventWithSubtype(MESSAGE_SUBTYPES.CHANNEL_NAME), addMessageToChannel],
    ...
    [makeMessageEventWithSubtype(MESSAGE_SUBTYPES.GROUP_NAME), addMessageToChannel]
];
