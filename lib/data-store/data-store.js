...
SlackDataStore.prototype.cacheRtmStart = function(data) {
  ...
  // TODO(leah):
  //   * Figure out how to stash team + self user in an appropriately abstracted way
  //   * Figure out whether the richer info on rtm.start (prefs etc.) for team + self user is actually needed?
